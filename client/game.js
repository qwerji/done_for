const GameStateManager = (() => {
    ...
    const worldMap = {
        'Ship': {
            ...
            imgURL: 'imgs/locations/ship.svg'
        },
        'Ship Computer': {
            ...
            options: [
                { type: 'travel', text: 'Back to the main cabin', dest: 'Ship' }
            ],
            imgURL: 'imgs/locations/ship_computer.svg'
        },
        'Armory': {
            ...
            imgURL: 'imgs/locations/armory.svg'
        },
        'Crash Site': {
            ...
            imgURL: 'imgs/locations/crash_site.svg'
        },
        'Forest Exterior': {
            ...
            imgURL: 'imgs/locations/crystal_forest.svg'
        },
        'Forest Interior': {
        ...
        "Alien's House": {
            ...
            imgURL: 'imgs/locations/alien.svg'
        },
        'Get Red Stone': {
        ...
        'Wastes': {
            ...
            imgURL: 'imgs/locations/wastes.svg'
        },
        'Behind Ship': {
            ...
            imgURL: 'imgs/locations/behind_ship.svg'
        },
        'Lake': {
            ...
            imgURL: 'imgs/locations/lake.svg'
        },
        'Lake Hole': {
            ...
            imgURL: 'imgs/locations/in_lake.svg'
        },
        'Inscriptions': {
            ...
            imgURL: 'imgs/locations/hint.svg'
        },
        'Lake Tunnel': {
        ...
        'Crystal Cavern': {
            ...
            imgURL: 'imgs/locations/crystal_cavern.svg'
        },
        'Cavern Opening': {
        ...
        'Base': {
            ...
            imgURL: 'imgs/locations/base.svg'
        },
        'Dark Room': {
            ...
            imgURL: 'imgs/locations/hallway.svg'
        },
        'Hallway': {
        ...
        'Command Center': {
            ...
            imgURL: 'imgs/locations/command_center.svg'
        },
        'Inactive Teleporter': {
            ...
            imgURL: 'imgs/locations/teleporter.svg'
        },
        'Book Room': {
            ...
            imgURL: 'imgs/locations/book_room.svg'
        },
        'Book Hint': {
            prompt: 'Interesting.',
            options: [
    ...
    function removeItem(situation, hero) {
        ...
        if (situation.options.length) {
            for (let i = 0; i < situation.options.length; i++) {
    ...
    const filterLocation = {
        ...
        'Active Command Center': (situation, hero) => {
        ...
        'Behind Ship': (situation, hero) => {
            if (hero.inventory['digger_laser']) {
                ...
                situation = {
                    ...
                    imgURL: 'imgs/locations/monster.svg'
                }
        ...
        "Alien's House": (situation, hero) => {
            if (attributes['alien_flashlight'] || attributes['alien_rude']) {
                ...
                if (hero.inventory['red_stone'] && hero.inventory['blue_stone'] && hero.inventory['green_stone']) {
                    situation.options.push({ type: 'win', text: 'Show it the 3 Stones' })
                }
            }
            if (hero.inventory['flashlight']) {
                situation.options.splice(
                    0, 0, { type: 'attr', text: 'Show it the Flashlight', attr: 'alien_flashlight' }
                )
            }
            if (hero.inventory['flat_crystal']) {
                situation.options.splice(
                    0, 0, { type: 'travel', text: 'Show it the Flat Crystal', dest: 'Get Red Stone' }
                )
            }
            return situation
        }
    ...
    publicMethods.refresh = () => {
        // Attributes are refreshed, unlike the world map,
        // which is untouched because of the deep copy
        attributes = getFreshAttributes()
    }
